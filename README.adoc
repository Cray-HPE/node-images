...
`https://myserver.net/sles-mirror/Products/SLE-Module-Basesystem/15-SP2/x86_64/product     SUSE-SLE-Module-Basesystem-15-SP2-x86_64-Pool     -g -p 99  suse/SLE-Module-Basesystem/15-SP2/x86_64/product`
...
mkdir -p iso
wget https://<somepath>/SLE-15-SP2-Full-x86_64-GM-Media1.iso -O iso/SLE-15-SP2-Full-x86_64-GM-Media1.iso
./scripts/setup.sh
```
